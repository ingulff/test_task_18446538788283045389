...
inline int main_helper(int argc, char **argv, std::ostream & out_stream)
{
	...
	{
		tt_program::utils::print_message(out_stream, ex.what());
		tt_program::utils::print_message(out_stream, tt_program::settings::help_message);
	...
	{
		tt_program::utils::print_message(out_stream, "Unknown exception caught\n");
